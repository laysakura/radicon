	...
	; HI-TECH C Compiler for PIC10/12/16 MCUs V9.70
	...
	; Compiler options:
	;
	; -oinfrated_ray_project.cof -minfrated_ray_project.map \
	; --summary=default --output=default ir_in.p1 ir_main.p1 ir_out.p1 \
	; lcd.p1 --chip=16F886 -P --runtime=default --opt=default -D__DEBUG=1 \
