...
/*==============================================================================*/
/* Motion制御定義     written by masa                                                         */
/*==============================================================================*/
#define MOVE_FORWARD             0x0A /*b'00001010'*/        /* LED All On                       */
#define MOVE_BACKWARD            0x05 /*b'00000101'*/        /* LED All Off                      */
#define MOVE_LEFT                0x04 /*b'00001000'*/
#define MOVE_RIGHT               0x01 /*b'00000010'*/
#define MOVE_STOP                0x00 /*b'00000000'*/

#define FORWARD                  0x5D
#define BACKWARD                 0x6D
#define STOP                     0x0D
#define RIGHT                    0xFD
#define LEFT                     0xFF
...
/* KEY Code Data Type   */
enum {
    KEY_CODE01 = 0,     /* key： 1 -> ファンクションキー： 1 */
    KEY_CODE02,         /* key： 2 -> ファンクションキー： 2 */
    KEY_CODE03,         /* key： 3 -> ファンクションキー： 3 */
    KEY_CODE04,         /* key： 4 -> ファンクションキー： 4 */
    KEY_CODE05,         /* key： 5 -> 動作キー          ： 1 */
